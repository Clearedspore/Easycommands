...
public class Tpa implements CommandExecutor {
    ...
    public Tpa(TeleportManager teleportManager, JavaPlugin plugin) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        teleportManager.addRequest(requester.getUniqueId(), target.getUniqueId());
        target.sendMessage(ChatColor.BLUE + requester.getName() + " has requested to teleport to you. Type /tpaccept to accept.");
        ...
        }.runTaskLater(plugin, 1200); // 60 seconds later
